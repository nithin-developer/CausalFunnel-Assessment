...
const Sparkline = () => (
  ...
  >
    <path
      d="M1 15L10 10L18 13L28 5L35 8L45 2L59 12"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
  ...
  return (
    <div className="w-full max-w-6xl mx-auto pb-12 px-5 animate-fade-in-up">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 border border-gray-200   bg-white text-sm font-medium text-emerald-600 hover:bg-emerald-50 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="border border-gray-200 bg-white   p-5 flex flex-col justify-between">
          <div>
        ...
        <div className="border border-gray-200 bg-white   p-5 flex flex-col justify-between">
          ...
          <div className="mt-4 text-xs">
            <span className="text-emerald-600 font-medium">↑ 18.6%</span>{" "}
            <span className="text-gray-400">vs last 7 days</span>
          </div>
        </div>
        ...
        <div className="border border-gray-200 bg-white   p-5 flex flex-col justify-between">
          ...
          <div className="mt-4 text-xs">
            <span className="text-emerald-600 font-medium">↑ 10.3%</span>{" "}
            <span className="text-gray-400">vs last 7 days</span>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200   overflow-hidden">
        <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-200   text-sm w-full sm:w-64 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
            />
          </div>
        </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4 font-mono text-xs text-emerald-600 font-medium flex items-center gap-3">
                        <div
                          className={`w-4 h-4 rounded-full border flex items-center justify-center ${isSelected ? "border-emerald-500" : "border-gray-300 group-hover:border-emerald-400"}`}
                        >
                          {isSelected && (
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-1 text-sm font-medium text-gray-500 hover:text-emerald-600 disabled:opacity-50 disabled:hover:text-gray-500 transition-colors bg-white px-3 py-1.5 border border-gray-200  "
          >
          ...
          <button
            ...
            className="flex items-center gap-1 text-sm font-medium text-emerald-600 hover:text-emerald-700 disabled:opacity-50 transition-colors bg-white px-3 py-1.5 border border-gray-200  "
          >
                  ...
                  <div>
                    ...
                    <div className="font-medium mt-1">
                      {(() => {
                        ...
                        return s?.first_event && s?.last_event
                          ? formatDurationStr(s.first_event, s.last_event)
                          : "-";
                      })()}
                    </div>
                  </div>
